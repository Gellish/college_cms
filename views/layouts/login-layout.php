...
<head>
	...
	<meta property="og:title" content="RDevelopment on open source technology | College Management Software | School Management Software" />
...
<div class="login-footer"> <strong>Copyright &copy; <?= date('Y') ?> <a href="http://www.tammanager.com">www.tammanager.com</a>.</strong> All rights reserved.</div>
<?php $this->endBody() ?>
</body>
</html>
<script>
